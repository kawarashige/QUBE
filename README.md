...
# 課題解決の対象
## モチベーションの維持が難しく、物事を継続して行いにくい人

# どの様に課題解決を狙うのか
## モチベーションの維持と無意識に継続できる環境の提供

# なぜルービックキューブなのか
## 試行錯誤を繰り返しながら、継続することの大切さを学べたきっかけだから。
## 平面上で立体構造を再現することに興味を惹かれたから。

# ・その課題解決の具体策は何か
## ・モチベーションの維持
### ・ユーザー同士のコミュニケーションを取れる
### →互いに教えあえる、気の合う仲間を見つけ楽しく行うことがモチベーションの維持に繋がると考えたから
### ・不要になったもの互いに無料で渡すことできる環境
### →裾野を広げることの狙いもありますが、善意で人に与えることが一番のモチベーション維持につながると考えたから
### ・ルービックキューブについて調べ、情報交換
### →知ることで得られる楽しさもあると考えたから。

## ・無意識
### ・ルービックキューブをログイン画面に配置し、入る事の出来るチャットルームの制限
### →ユーザーの向上心を刺激する

### ・出席簿を用意することで、継続を可視化する
### →ログインするだけでなくその先を用意することで、目的をすり替える狙い
...
## ・これからどうしていくか
## Three.jsによって関数を定義していきルービックキューブに変化をつけていくことが難しいと考えたために、WebGLと呼ばれるAPIを学んでおります。
